...
public class Constants {
  ...
  public static final String METHOD_NAME_DECORATION = "fromJson";
  public static final String METHOD_DECORATION_PARAM_KEY_JSON = "json";

  public static final String METHOD_NAME_IMPL = "fromJson";
  public static final String METHOD_IMPL_PARAM_KEY_JSON = "json";
  public static final String METHOD_IMPL_LOCAL_VAR_BEAN = "bean";
